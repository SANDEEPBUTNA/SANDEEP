...
public class NewEgg {
	...
	public static void main(String[] args) {
		...
		String chromePath = "C:\\Users\\Sandeep Butna\\Desktop\\Sandeeps\\Softwares\\chromedriver.exe";
		...
		driver.findElement(By.xpath(".//div[contains(@class,'items-view')]/div[2]/div/div[2]/div/div[1]/button")).click();
		...
		System.out.println("Error Message while logging into gmail displayed as: Your password was changed 22 days ago");
